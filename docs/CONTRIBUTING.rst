...
.. code-block:: git
   ...
   `elasticsearch package`, this formula no longer supports the installation of
   packages.
...
* `elasticsearch-formula <https://github.com/saltstack-formulas/elasticsearch-formula>`_
