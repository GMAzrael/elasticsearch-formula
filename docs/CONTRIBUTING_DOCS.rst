...
.. |docs| image:: https://readthedocs.org/projects/docs/badge/?version=latest
   ...
   :scale: 100%
   :target: https://elasticsearch-formula.readthedocs.io/en/latest/?badge=latest
...
#. Use the
   :ref:`provided page elasticsearch <saltstack_formulas_rst_page_elasticsearch>`
...
SaltStack-Formulas' RST page elasticsearch
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

.. _saltstack_formulas_rst_page_elasticsearch

Use the following elasticsearch when creating a new page.
